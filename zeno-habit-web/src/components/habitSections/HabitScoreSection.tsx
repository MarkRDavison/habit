...
const _HabitScoreSection: React.FC<Props> = (props: Props) => {
    return (
        <div data-testid='HabitScoreSection'>
            <h1>HabitScoreSection</h1>
        </div>
    );
};
...
const HabitScoreSection = withRouter(connect(
    mapStateToProps,
    mapDispatchToProps
)(_HabitScoreSection));
export default HabitScoreSection;