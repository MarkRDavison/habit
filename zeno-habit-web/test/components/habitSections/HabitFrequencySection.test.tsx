...
import HabitFrequencySection from '../../../src/components/habitSections/HabitFrequencySection';
...
describe('HabitFrequencySection', () => {
    const habit: Habit = {
        id: '1',
        name: 'Habit Number 1',
        createdDate: 'today',
    ...
    test('component can be rendered', () => {
        ...
        const HabitFrequencySection = screen.queryByTestId('HabitFrequencySection');
        expect(HabitFrequencySection).toBeValid();
    });
});