...
import HabitScoreSection from '../../../src/components/habitSections/HabitScoreSection';
...
describe('HabitScoreSection', () => {
    ...
    test('component can be rendered', () => {
        ...
        const habitScoreSection = screen.queryByTestId('HabitScoreSection');
        expect(habitScoreSection).toBeValid();
    });
});